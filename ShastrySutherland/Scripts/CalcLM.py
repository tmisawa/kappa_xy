...
def func_calc3(flag,LeviCivita,All_J,all_val3,dict_spin,siteI,siteJ,siteK):
    tmp=0.0
    for a0, a1, b0, b1, c0 in itertools.product(flag, flag, flag, flag, flag):
        tmp_val  = all_val3[siteI][b0][siteJ][c0][siteK][b1]
        #print(tmp_val)
        tmp     += LeviCivita[a0][c0][a1] * tmp_val * All_J[siteI][siteJ][a0][b0] * All_J[siteJ][siteK][a1][b1]
    return tmp

def func_calc2(flag,LeviCivita,All_J,all_h,all_val2,dict_spin,siteI,siteJ):
    tmp = 0.0
    for a0,b0,c0,c1 in itertools.product(flag,flag,flag,flag):
        print(a0,b0,c0,c1)
        tmp_val = all_val2[siteI][c1][siteJ][b0]-all_val2[siteI][b0][siteJ][c1]
        tmp    += LeviCivita[c0][a0][c1]*tmp_val*All_J[siteI][siteJ][a0][b0]*all_h[c0]
    return tmp
