...
From the comparison with the classical counterpart, we reveal that the effects of the $\Gamma$ term go beyond the classical picture, indicating significant quantum fluctuation effects, while those of the $\Gamma^\prime$ term is well captured at the classical level. 
...
While the magnon picture also predicts a sign change in $\kappa_{xy}/T$ in the context of topological magnons~\cite{Joshi2018, ChernZK2021,ZhangCK2021}, the predicted sign in the polarized state for the [$11\bar{2}$] field is opposite to that expected from the topological Majorana fermion picture. 
...
Although the enhanced $\kappa_{xy}/T$ with overshooting behavior is observed across a broad field range, including the regime beyond the quantum critical point, it cannot be attributed solely to topological magnons, whose contributions are relatively small and exhibit an opposite sign at high temperatures~\cite{McClartyDGRPMP2018}.
...
In the Kitaev model under a magnetic field, the nature of quasiparticles is expected to crossover from Majorana fermions, which are valid at zero field, to magnons, which are appropriate in the polarized reigme at strong fields. 
...
Our findings highlight the significance of this approach, revealing that even a small magnetic field and additional interactions amounting to just a few percent of the Kitaev interaction strength can lead to behavior beyond the predictions of perturbation theory. 
